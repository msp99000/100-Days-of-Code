"""
MiKee loves running. He often visits his favourite Nehru Park and runs for very long distances. On one such visit he found that 
...
for a single continuous stretch of K kilometres. Now he wants to know what is the maximum number of girls that he can impress.
Input
